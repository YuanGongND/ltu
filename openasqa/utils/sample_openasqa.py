...
with open('/data/sls/scratch/yuangong/ltu/openasqa/data/openasqa_9.4M_v2_noqa.json', 'r') as file:
    data = json.load(file)
...
with open('/data/sls/scratch/yuangong/ltu/openasqa/data/openasqa_toy.json', 'w') as outfile:
